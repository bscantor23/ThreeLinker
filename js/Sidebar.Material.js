...
function SidebarMaterial( editor ) {
	...
	const materialEmissiveIntensity = new SidebarMaterialNumberProperty( editor, 'emissiveIntensity', strings.getKey( 'sidebar/material/emissiveIntensity' ), [ 0, 10 ] );
	container.add( materialEmissiveIntensity );
	...
	const materialBumpScale = new SidebarMaterialNumberProperty( editor, 'bumpScale', strings.getKey( 'sidebar/material/bumpScale' ), [ 0, 10 ] );
	container.add( materialBumpScale );
	...
	const materialNormalScale = new SidebarMaterialNumberProperty( editor, 'normalScale', strings.getKey( 'sidebar/material/normalScale' ), [ -10, 10 ] );
	container.add( materialNormalScale );
	...
	const materialDisplacementScale = new SidebarMaterialNumberProperty( editor, 'displacementScale', strings.getKey( 'sidebar/material/displacementScale' ), [ 0, 10 ] );
	container.add( materialDisplacementScale );

	// displacementBias

	const materialDisplacementBias = new SidebarMaterialNumberProperty( editor, 'displacementBias', strings.getKey( 'sidebar/material/displacementBias' ), [ -10, 10 ] );
	container.add( materialDisplacementBias );
	...
	const materialEnvMapIntensity = new SidebarMaterialNumberProperty( editor, 'envMapIntensity', strings.getKey( 'sidebar/material/envMapIntensity' ), [ 0, 10 ] );
	container.add( materialEnvMapIntensity );
	...
	const materialLightMapIntensity = new SidebarMaterialNumberProperty( editor, 'lightMapIntensity', strings.getKey( 'sidebar/material/lightMapIntensity' ), [ 0, 10 ] );
	container.add( materialLightMapIntensity );
	...
	const materialAOMapIntensity = new SidebarMaterialNumberProperty( editor, 'aoMapIntensity', strings.getKey( 'sidebar/material/aoMapIntensity' ), [ 0, 10 ] );
	container.add( materialAOMapIntensity );
		...
		if ( material ) {
			...
			if ( material.type !== materialClass.getValue() ) {
				...
				if ( material.type === 'MeshPhysicalMaterial' && currentMaterial.type === 'MeshStandardMaterial' ) {
					...
					const properties = [
						'color', 'emissive', 'emissiveIntensity', 'roughness', 'metalness', 'map', 'emissiveMap', 'alphaMap',
						'bumpMap', 'bumpScale', 'normalMap', 'normalScale', 'displacementMap', 'displacementScale', 'displacementBias',
						'roughnessMap', 'metalnessMap', 'envMap', 'envMapIntensity', 'lightMap', 'lightMapIntensity', 
						'aoMap', 'aoMapIntensity', 'side'
					];
